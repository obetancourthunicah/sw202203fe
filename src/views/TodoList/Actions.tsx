...
const Actions = ({actionHandler = (action:string)=>{}}:IPropsActions)=>{
  ...
  return (
    <section className="TodoListActions">
      <Button name="Todos" onClick={clickHandler}>Todos</Button>
      <Button name="Pendientes" onClick={clickHandler}>Pendientes</Button>
      <Button name="Completados" onClick={clickHandler}>Completados</Button>
    </section>
  );
}
